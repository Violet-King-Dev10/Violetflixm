...
export function AIChatbot() {
  ...
  const [messages, setMessages] = useState<{ role: 'user' | 'bot'; text: string }[]>([
    { role: 'bot', text: "Hello! I'm your VioletFlix Movie assistant. I can tell you about the app or creator. How can I help you today?" }
  ]);
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-[60] w-[90%] max-w-[450px] h-[600px] bg-[#1a1a1a] rounded-3xl border border-white/10 shadow-2xl flex flex-col overflow-hidden"
            >
              <div className="bg-red-600 p-5 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <Bot className="w-6 h-6 text-white" />
                  <div>
                    <h3 className="font-bold text-white text-sm">VioletFlix Movie Assistant</h3>
